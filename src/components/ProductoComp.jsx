...
export default function ProductoComp({imagen, nombre, referencia, cantidad, tamano, categoria, material, precio}){
    return<>
    <div className="flex flex-col h-full w-full items-center" >
        ...
        <div className="flex flex-row items-center justify-between w-[80%] mb-4 mt-4 h-[140px]">
            ...
            <div className="flex flex-col items-center h-[100%] justify-around">
                <img src={editar} alt="" className="h-10 cursor-pointer" />
