export default function ProductoParaOferta({ imagen, nombre, referencia, cantidad, tamanio, categoria, material, precio, handleChange }) {
    return (
      <div className="flex flex-row items-center justify-between w-[80%] mb-10">
        ...
        <div className="flex-none flex items-center justify-center">
          <input 
            type="checkbox" 
            className="ml-4 h-10 w-10 rounded-[4px] text-2xl" 
            value={referencia} 
